...
int main() {
    ...
    if (strcmp(pegawai.golongan, "D1") == 0) {
        strcpy(pegawai.gaji, "3000000");
    } else if (strcmp(pegawai.golongan, "D2") == 0) {
        strcpy(pegawai.gaji, "2500000");
    } else if (strcmp(pegawai.golongan, "D3") == 0) {
        strcpy(pegawai.gaji, "2000000");
    } else {
    ...
    printf("\nGaji Pokok Anda: Rp");
    int len = strlen(pegawai.gaji);
    for(int i = 0; i < len; i++) {
        printf("%c", pegawai.gaji[i]);
        if ((i - len % 3 + 1) % 3 == 0 && i != len - 1) {
            printf(".");
        }
    }
    printf("\n");
